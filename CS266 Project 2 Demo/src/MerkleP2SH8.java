	...
	public static void main(String [] args) throws Exception
	  {
		...
		long beforeUsedMem=Runtime.getRuntime().totalMemory()-Runtime.getRuntime().freeMemory();
	  	...
	  	// Hash script
	  	ScriptHashOut redeemScript = new ScriptHashOut();
	  	
	  	// Put into string format
	  	String hashNode1 = redeemScript.hashScript();
	  	String hashNode2 = redeemScript.hashScript();
	  	String hashNode3 = redeemScript.hashScript();
	  	String hashNode4 = redeemScript.hashScript();
	  	String hashNode5 = redeemScript.hashScript();
	  	String hashNode6 = redeemScript.hashScript();
	  	String hashNode7 = redeemScript.hashScript();
	  	String hashNode8 = redeemScript.hashScript();
